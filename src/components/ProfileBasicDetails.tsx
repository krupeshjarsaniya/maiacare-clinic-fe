...
//     const [medicalHistoryFormData, setMedicalHistoryFormData] = useState<MedicalHistoryType | unknown>([]);
...
//     const [modalFormFertilityData, setModalFormFertilityData] = useState<FertilityAssessmentFormType | unknown>([]);
