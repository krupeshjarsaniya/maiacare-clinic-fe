...
import { getAppointmentById } from "@/utlis/apis/apiHelper";
    ...
    getAppointmentById(AppointmentId)
      .then((response) => {
        if (response.status === 200) {
          ...
          dispatch(
            setHeaderData({
              title: appointmentData.patient.name,
              subtitle: `Appointments > ${appointmentData.patient.name}`,
            })
          );
        } else {
  ...
  return (
    <>
      <div>
        ...
        {loading ? (
          <>
            <Card className="shadow-sm rounded-4 patient-profile-card p-3">
              ...
              <div className="d-flex justify-content-between align-items-start  ">
                ...
                <div>
                  <Button
                    ...
                    onClick={() =>
                      router.push(`/patients/${appointment?.patient?._id}`)
                    }
                  >
                    Go to Profile
